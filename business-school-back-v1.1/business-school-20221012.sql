...
CREATE TABLE `parameter`  (
  ...
  `appeal` bigint NULL DEFAULT NULL COMMENT '众裁申诉期',
  `peoper` bigint NULL DEFAULT NULL COMMENT '众裁人数',
  `Publisher` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '发布者',
  `Respondent` varchar(100) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '悬赏者',
  `collect` bigint NULL DEFAULT NULL COMMENT '收集时间',
...
CREATE TABLE `reward`  (
  ...
  `status` varchar(2) CHARACTER SET utf8 COLLATE utf8_bin NULL DEFAULT NULL COMMENT '10 草稿 11 已发布 ',
  `verify` tinyint(1) NULL DEFAULT NULL COMMENT '0未通过 1审核中 2通过',
  `amount` int NULL DEFAULT NULL,
  `end_time` datetime NULL DEFAULT NULL,
  `shield` tinyint(1) NULL DEFAULT NULL COMMENT '屏蔽 0否 1是',
  `del` tinyint(1) NULL DEFAULT NULL COMMENT '0否 1是',
  `top` tinyint(1) NULL DEFAULT NULL,
  `best_answer` tinyint(1) NULL DEFAULT NULL,
  `recommend` tinyint(1) NULL DEFAULT NULL,
  `time_out` tinyint(1) NULL DEFAULT NULL COMMENT '0正常 1超时',
  `published_time` datetime NULL DEFAULT NULL,
  `create_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`reward_id`) USING BTREE,
  INDEX `FK_Reference_1`(`id`) USING BTREE,
  CONSTRAINT `FK_Reference_1` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '主表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of reward
-- ----------------------------
INSERT INTO `reward` VALUES (1, 1, '悬赏1', '与气候变化赛跑，中国企业一马当先。经过多年的产业积累，中国企业已在绿色交通领域具有主场优势——中国企业生产了全球超过一半的电动汽车，同时成为目前全球电池产业的中心，电池产量与市场规模均居世界第一，实现了在汽车产业的换道超车。\r\n\r\n在加入远景集团之前，弗朗茨在德企担任了20多年高管，主要负责豪华车细分市场。“一个偶然的机会，我听到远景集团创始人兼首席执行官张雷分享集团对可再生能源、电池、储能、充电和智能物联领域的关注和探索，用科技创新助力零碳转型，非常具有前瞻性，与我当时做的工作不一样。”弗朗茨回忆道，于是他决定加入这家全球领先的绿色科技公司，为公司发展助力，学习更多新事物。', '11', 2, 11111, NULL, NULL, NULL, 1, NULL, NULL, NULL, '2022-10-04 14:22:32', '2022-10-04 10:23:11');
...
INSERT INTO `reward` VALUES (4, 1, '悬赏2', '2321312', '11', 2, 10000, NULL, NULL, NULL, 0, NULL, NULL, NULL, '2022-10-07 03:50:22', '2022-10-06 14:50:25');
INSERT INTO `reward` VALUES (5, 1, '悬赏3', '这个阿斯蒂芬所发生的', '11', 2, 20062, NULL, NULL, NULL, 0, NULL, NULL, NULL, '2022-10-07 14:51:15', '2022-10-07 14:51:12');
INSERT INTO `reward` VALUES (6, 1, '悬赏4', '中国有多少个省市', '11', 2, 15021, NULL, NULL, NULL, 0, NULL, NULL, NULL, '2022-10-07 14:52:04', '2022-10-07 14:52:02');
INSERT INTO `reward` VALUES (7, 1, '悬赏5', '123321', '11', 2, 123456, NULL, NULL, NULL, 0, NULL, NULL, NULL, '2022-10-07 17:25:41', '2022-10-07 17:25:38');
INSERT INTO `reward` VALUES (1507414501228576, 1, '发布的悬赏001', '<p><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span></p>', '11', 2, 1000, '2022-10-14 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-11 16:14:08', '2022-10-11 16:14:08');
INSERT INTO `reward` VALUES (1507414677389344, 1, '保存草稿的悬赏001', '<p><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬</span></p><p><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span><span style=\"color: #606266; font-family: Inter, -apple-system, BlinkMacSystemFont, &quot;Segoe UI&quot;, Roboto, Oxygen, Ubuntu, Cantarell, &quot;Fira Sans&quot;, &quot;Droid Sans&quot;, &quot;Helvetica Neue&quot;, sans-serif; font-size: 14px; background-color: #FFFFFF;\">悬赏内容</span></p><p><br/></p><p>helllo world</p><p>徐是哪个</p>', '10', 2, 2536, '2022-10-14 00:00:00', 0, 0, 0, 0, 0, 0, NULL, '2022-10-11 16:15:32');
INSERT INTO `reward` VALUES (1507416529174560, 1, 'fffffff', '<p>12312312321</p>', '11', 2, 1, '2022-10-13 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-11 16:30:14', '2022-10-11 16:30:14');
INSERT INTO `reward` VALUES (1507416634032160, 1, 'sdfsdfsdfsdf', '<p>1231231232112312312321123123123211231231232112312312321123123123211231231232112312312321123123123211231231232112312312321</p>', '11', 2, 1, '2022-10-13 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-11 16:31:04', '2022-10-11 16:31:04');
INSERT INTO `reward` VALUES (1507416688558112, 1, 'sdfsdfsdfsdf', '<p>1231231232112312312321123123123211231231232112312312321123123123211231231232112312312321123123123211231231232112312312321</p>', '11', 2, 1, '2022-10-13 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-11 16:31:31', '2022-10-11 16:31:31');
INSERT INTO `reward` VALUES (1507424185876512, 1, '定时任务1', '<p>1232131</p>', '11', 2, 111, '2022-10-11 17:32:00', 0, 0, 0, 0, 0, 0, '2022-10-11 17:31:06', '2022-10-11 17:31:06');
INSERT INTO `reward` VALUES (1507424701775904, 1, '定时任务2', '<p>1232131</p>', '11', 2, 111, '2022-10-11 17:36:00', 0, 0, 0, 0, 0, 0, '2022-10-11 17:35:11', '2022-10-11 17:35:11');
INSERT INTO `reward` VALUES (1507604144586784, 1, '共产党', '<p>12121212</p>', '11', 2, 1212, '2022-10-29 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:21:16', '2022-10-12 17:21:16');
INSERT INTO `reward` VALUES (1507604601765920, 1, '我发布的悬赏1', '<p>12121212</p>', '11', 2, 1212, '2022-10-29 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:24:55', '2022-10-12 17:24:55');
INSERT INTO `reward` VALUES (1507604610154528, 1, '我发布的悬赏2', '<p>12121212</p>', '11', 2, 1212, '2022-10-29 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:24:59', '2022-10-12 17:24:59');
INSERT INTO `reward` VALUES (1507604618543136, 1, '我发布的悬赏3', '<p>12121212</p>', '11', 2, 1212, '2022-10-29 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:25:02', '2022-10-12 17:25:02');
INSERT INTO `reward` VALUES (1507604626931744, 1, '我发布的悬赏4', '<p>12121212</p>', '11', 2, 1212, '2022-10-29 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:25:07', '2022-10-12 17:25:07');
INSERT INTO `reward` VALUES (1507606134784032, 1, '腐败', '<p>sdfsffsd</p>', '10', NULL, 111, '2022-10-14 00:00:00', 0, 0, 0, 0, 0, 0, NULL, '2022-10-12 17:37:05');
INSERT INTO `reward` VALUES (1507606862495776, 1, '312321', '<p>13213213</p>', '11', 1, 1, '2022-10-14 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:42:53', '2022-10-12 17:42:53');
INSERT INTO `reward` VALUES (1507606933798944, 1, NULL, '', '10', NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL, '2022-10-12 17:43:27');
INSERT INTO `reward` VALUES (1507607038656544, 1, '312312312', '<p>13213123</p>', '11', 1, 1, '2022-10-15 00:00:00', 0, 0, 0, 0, 0, 0, '2022-10-12 17:44:16', '2022-10-12 17:44:16');
INSERT INTO `reward` VALUES (1507607051239456, 1, NULL, '', '10', NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, NULL, '2022-10-12 17:44:22');
INSERT INTO `reward` VALUES (1507607361617952, 1, '31321312', '<p>221312312</p>', '10', NULL, 1, '2022-10-22 00:00:00', 0, 0, 0, 0, 0, 0, NULL, '2022-10-12 17:46:50');
INSERT INTO `reward` VALUES (1507607437115424, 1, '2131', '<p>1232131</p>', '10', NULL, 1, '2022-10-15 00:00:00', 0, 0, 0, 0, 0, 0, NULL, '2022-10-12 17:47:27');
INSERT INTO `reward` VALUES (1507607460184096, 1, '12321312', '<p>12321312</p>', '11', 1, 1, '2022-10-12 17:47:34', 0, 0, 0, 0, 0, 0, '2022-10-12 17:47:37', '2022-10-12 17:47:37');
...
CREATE TABLE `reward_answer`  (
  ...
  `id` bigint NULL DEFAULT NULL,
  `content` text CHARACTER SET utf8 COLLATE utf8_bin NULL,
  `best_answer` tinyint(1) NULL DEFAULT NULL COMMENT '0否 1是',
  `answer_time` datetime NULL DEFAULT NULL,
  PRIMARY KEY (`answer_id`) USING BTREE,
  INDEX `FK_Reference_2`(`reward_id`) USING BTREE,
  INDEX `FK_Reference_3`(`id`) USING BTREE,
  CONSTRAINT `FK_Reference_2` FOREIGN KEY (`reward_id`) REFERENCES `reward` (`reward_id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `FK_Reference_3` FOREIGN KEY (`id`) REFERENCES `user` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8 COLLATE = utf8_bin ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of reward_answer
-- ----------------------------
INSERT INTO `reward_answer` VALUES (1506514875449376, 1, 1, '<p>dsfdsfdsfsd</p>', 0, '2022-10-06 17:04:32');
INSERT INTO `reward_answer` VALUES (1506516829995040, 1, 1, '<p>1231232132132</p>', 0, '2022-10-06 17:20:04');
INSERT INTO `reward_answer` VALUES (1506676863664160, 1, 1, '<p>回答</p>', 0, '2022-10-07 14:31:54');
INSERT INTO `reward_answer` VALUES (1506685338255392, 2, 1, '<p>回答</p>', 0, '2022-10-07 15:39:15');
INSERT INTO `reward_answer` VALUES (1506692843962400, 2, 1, '<p>回答123</p>', 0, '2022-10-07 16:38:55');
INSERT INTO `reward_answer` VALUES (1507420134178848, 1507414501228576, 1, '<p>sfsfsfs</p>', 0, '2022-10-11 16:58:54');
...
CREATE TABLE `statistic`  (
  ...
  `catalog` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL COMMENT '栏目',
...
) ENGINE = InnoDB AUTO_INCREMENT = 126 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '系统访问记录' ROW_FORMAT = Dynamic;
...
) ENGINE = InnoDB AUTO_INCREMENT = 102 CHARACTER SET = utf8 COLLATE = utf8_bin COMMENT = '操作日志记录' ROW_FORMAT = Dynamic;
...
CREATE TABLE `user`  (
  ...
  `sex` tinyint(1) NULL DEFAULT NULL COMMENT '0男 1女 2未知',
  `enabled` tinyint(1) NULL DEFAULT NULL COMMENT '0停用 1启用',
